# Manual to Automation @ <a href="https://sky.co.uk/"><img src="https://logos-world.net/wp-content/uploads/2021/02/Sky-Logo.png" alt="playwright" height="27" /></a> - Lesson 1 - Exercise

## Introduction

This code is the solution to the practical exercise (and bonus exercise) given at the end of Lesson 1.
...
```sh
git clone https://github.com/Manual-To-Automation-Sky-Italia/Lesson-1-Exercise.git.
```
* Move into the directory that you just cloned by typing
```sh
cd Lesson-1-Exercise
```
